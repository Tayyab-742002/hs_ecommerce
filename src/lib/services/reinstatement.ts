...
const fallbackReinstatementServices = [
  {
    ...
    description:
      "Get your suspended Amazon Seller Central account back online with our expert reinstatement service.",
    features: [
  ...
  },
  {
    ...
    description:
      "Restore your suspended eBay seller account with our specialized reinstatement service.",
    features: [
  ...
  },
  {
    ...
    description:
      "Get your Walmart Marketplace seller account back in good standing with our reinstatement specialists.",
    features: [
...
export async function getReinstatementServices(
...
export async function getReinstatementServiceBySlug(
  slug: string,
  options = { useFallback: false }
) {
  ...
  if (!service) {
    throw new Error(
      `Reinstatement service with slug ${slug} not found in fallback data`
    );
  }
...
export async function getReinstatementServicesByPlatform(
  platformId: string,
  options = { useFallback: false }
) {
