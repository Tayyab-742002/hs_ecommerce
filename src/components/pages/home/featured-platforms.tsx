...
export function FeaturedPlatforms({ platforms }: FeaturedPlatformsProps) {
  ...
  const currentPlatform =
    platforms.find((p) => p._id === activePlatform) || topPlatforms[0];
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    {(currentPlatform.features || defaultFeatures).map(
                      (feature, index) => (
                        <div key={index} className="flex space-x-4">
                          <div className="flex-shrink-0 mt-1">
                            <CheckCircle
                              className="w-5 h-5"
                              style={{
                                color: getPlatformColor(currentPlatform.name),
                              }}
                            />
                          </div>
                          <div>
...
const defaultFeatures = [
  {
    ...
    description: "Ready to use accounts with full verification",
  },
  {
    title: "Multiple Country Options",
    description: "Available for all major geographic regions",
  },
  {
    title: "Quick Delivery",
    description: "Most accounts delivered within 24-48 hours",
  },
  {
    title: "VA Services Available",
    description: "Expert virtual assistants for account management",
  },
];
