        ...
        >
          <motion.div variants={itemVariants} className="order-2 lg:order-1">
            ...
            <p className="text-muted-foreground mb-6">
              Getting your account suspended can be devastating for your
              business. Our specialized team helps you get back online fast with
              our proven reinstatement process.
            </p>
          ...
          >
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                <div className="flex items-center gap-4 mb-2">
                  <div
                    ...
                    style={{ backgroundColor: getPlatformColor("Amazon") }}
                  ></div>
                ...
                <p className="text-white/80 text-sm">
                  Fast turnaround times from 3 to 21 days depending on platform
                </p>
              </div>
            </div>
            ...
            <div
              ...
              style={{ backgroundColor: `${getPlatformColor("Walmart")}15` }}
            ></div>
            <div
              className="absolute -bottom-4 -left-4 w-32 h-32 rounded-full -z-10"
              style={{ backgroundColor: `${getPlatformColor("eBay")}15` }}
            ></div>
          </motion.div>
        </motion.div>
      </div>
