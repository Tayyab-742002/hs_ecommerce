...
export type CallToActionProps = {
  ...
  primaryShimmerBackground?: string;
...
export function CallToAction({
  ...
  const isSpecialProtocol = (href: string) =>
    href.startsWith("tel:") || href.startsWith("mailto:");
  const shouldOpenNewTab = (href: string) =>
    isExternalUrl(href) && !isSpecialProtocol(href);
        ...
        >
          ...
          >
            <ShimmerButton
              ...
              background="#fb4141"
              onClick={() => {
                // Navigate using window to support external protocols (https, tel, mailto, wa)
            ...
            {secondaryText && secondaryHref ? (
              <Button
                ...
                asChild
                className={cn(
                  "rounded-full  px-6 py-1! border-2 backdrop-blur-sm",
                  secondaryButtonClassName
                )}
                style={{
