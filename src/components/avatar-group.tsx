      ...
      <AnimatePresence mode="popLayout">
        {isHovered && (
          <motion.div
            ...
            className="absolute -top-16 whitespace-nowrap flex text-xs flex-col items-center justify-center rounded-sm  bg-white z-50 shadow-lg px-4 py-2 border border-primary/50 min-w-max"
          >
            <div className="font-bold text-primary relative z-30 text-base text-center">
              {item.name}
            </div>
